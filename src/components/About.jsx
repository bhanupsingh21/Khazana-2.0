      ...
      <div className="section-inner" style={{ paddingTop: '120px', paddingBottom: '80px' }}>
        ...
        <div className="about-grid">
          <div className="about-visual reveal">
            ...
            <div className="about-stat-bubble" style={{ textAlign: 'center' }}>
              <div className="stat-number">25 Years</div>
              <div className="stat-label">Celebrating the Festival of Ghazals</div>
            </div>
          </div>
          <div className="about-content reveal reveal-delay-2">
            ...
            <p className="about-text">CPAA works alongside the medical fraternity, focusing on education, awareness, early detection, support to treatment, guidance, counselling, and rehabilitation for Cancer.</p>
            <p className="about-text">PATUT is the national non-profit organization dedicated to serving patients afflicted with Thalassemia.</p>
        ...
        <div className="about-hunt reveal" style={{ marginTop: '100px' }}>
          <div>
            ...
            <p className="hunt-text">KHAZANA ARTIST ALOUD TALENT HUNT is a unique, Pan-India talent hunt that seeks to amalgamate the magic of Ghazals. Winners get an exclusive chance to perform with legends like Anup Jalota, Rekha Bhardwaj, Sudeep Banerjee and many more.</p>
            <br />
